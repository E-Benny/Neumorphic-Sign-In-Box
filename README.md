## Neumorphic Sign-In Form
This repository contains an HTML file that displays a modern neumorphic login box superimposed over a psychedelic gif file. This project was created using HTML and SCSS.
...
## Live Version
To view the live version of the code without downloading the HTML file, please click on the CodePen link (https://codepen.io/E-Benny/pen/eYVMrQL).
